...
class ProductCategory(models.Model):
    ...
    coeff1_id = fields.Many2one('product.coefficient','Coeff Perte', domain="[('code','like','COEFF')]")
    coeff2_id = fields.Many2one('product.coefficient','Coeff2', domain="[('code','like','COEFF')]")
    coeff3_id = fields.Many2one('product.coefficient','Coeff3', domain="[('code','like','COEFF')]")
    coeff4_id = fields.Many2one('product.coefficient','Coeff4', domain="[('code','like','COEFF')]")
    coeff5_id = fields.Many2one('product.coefficient','Coeff5', domain="[('code','like','COEFF')]")
    coeffLOUVE_id = fields.Many2one('product.coefficient','LOUVE margin', domain="[('code','like','MRG')]")


class ProductTemplate(models.Model):
    _inherit = 'product.template'

    coeff1_id = fields.Many2one('product.coefficient','Coeff Perte',
    related='categ_id.coeff1_id', domain="[('code','like','COEFF')]" )
    coeff2_id = fields.Many2one('product.coefficient','Coeff2',
    related='categ_id.coeff2_id',domain="[('code','like','COEFF')]")
    coeff3_id = fields.Many2one('product.coefficient','Coeff3',
    related='categ_id.coeff3_id',domain="[('code','like','COEFF')]")
    coeff4_id = fields.Many2one('product.coefficient','Coeff4',
    related='categ_id.coeff4_id',domain="[('code','like','COEFF')]")
    coeff5_id = fields.Many2one('product.coefficient','Coeff5',
    related='categ_id.coeff5_id',domain="[('code','like','COEFF')]")
    coeffLOUVE_id = fields.Many2one('product.coefficient','LOUVE margin',
    related='categ_id.coeffLOUVE_id',domain="[('code','like','MRG')]")
    ...
    @api.onchange('coeffLOUVE_id','coeff5_inter','standard_price','taxes_id')
    def _compute_coeffLOUVE(self):
        _tt = 0.0 
        if self.coeffLOUVE_id.value != False:
    ...
    info_price = fields.Float('Prix avec taxes', compute="_compute_coeffLOUVE")
